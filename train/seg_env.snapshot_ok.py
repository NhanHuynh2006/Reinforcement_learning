...
class LaneFollowerSegEnv(gym.Env, Node):
    ...
    def __init__(
        ...
        self.segmenter = LaneSegmenter(yolo_weights=yolo_weights)
        ...
        self.off_lane_grace = 20
        self.off_lane_count = 0
        self.missing_mask_grace = 30
        self.missing_mask_count = 0
        self.terminate_on_offlane = False
        ...
        self.min_lane_width_px = 6
        self.max_lane_width_px = 60
